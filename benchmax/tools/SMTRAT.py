...
class SMTRAT(Tool):
    ...
    def parse_additional(self, result: Result):
        match result.exit_code:
            case  2: result.answer = "sat"
            case  3: result.answer = "unsat"
            case  4: result.answer = "unknown"
            case  5: result.answer = "wrong"
            case  9: result.answer = "nosuchfile"
            case 10: result.answer = "parsererror"
            case 11: result.answer = "timeout"
